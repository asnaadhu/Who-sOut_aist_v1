        ...
        <div className="flex items-center justify-between h-16 gap-2 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-3 shrink-0">
            ...
            <div className="relative hidden sm:block" ref={menuRef}>
              ...
              {isProfileMenuOpen && (
                <div className="fixed inset-x-3 top-20 sm:static sm:inset-auto sm:top-auto sm:absolute sm:right-0 sm:mt-2 w-auto sm:w-80 bg-white rounded-2xl sm:rounded-xl shadow-2xl sm:shadow-lg border border-neutral-200 p-4 z-50 animate-in fade-in zoom-in-95 duration-100 max-h-[85vh] flex flex-col space-y-3.5">
                  {/* Profile Header */}
