...
const BASE_LEAVE_TYPE_CONFIG: Record<string, LeaveTypeConfig> = {
  DO: {
    label: 'DO (Day Off)',
    bgClass: 'bg-[#E4E4E4] text-[#000000] border-[#000000]',
    textClass: 'text-[#000000]',
    borderClass: 'border-[#000000]',
    badgeBg: 'bg-[#E4E4E4] text-[#000000]',
    dotColor: 'bg-[#000000]',
    iconName: 'Coffee',
  ...
  PH: {
    ...
    bgClass: 'bg-[#FCA311] text-[#14213D] border-[#14213D]',
    textClass: 'text-[#14213D]',
    borderClass: 'border-[#14213D]',
    badgeBg: 'bg-[#FCA311] text-[#14213D]',
    dotColor: 'bg-[#FCA311]',
    iconName: 'Sparkles',
  ...
  AL: {
    ...
    bgClass: 'bg-[#14213D] text-white border-[#14213D]',
    textClass: 'text-[#14213D]',
    borderClass: 'border-[#14213D]',
    badgeBg: 'bg-[#14213D] text-white',
    dotColor: 'bg-[#14213D]',
    iconName: 'Palmtree',
  ...
  SL: {
    label: 'SL (Sick Leave)',
    bgClass: 'bg-[#000000] text-white border-[#000000]',
    textClass: 'text-[#000000]',
    borderClass: 'border-[#000000]',
  ...
  FRL: {
    ...
    bgClass: 'bg-[#E4E4E4] text-[#14213D] border-[#14213D]',
    textClass: 'text-[#14213D]',
    borderClass: 'border-[#14213D]',
    badgeBg: 'bg-[#E4E4E4] text-[#14213D]',
    dotColor: 'bg-[#14213D]',
    iconName: 'Users',
