...
### team_members
- "mem-asnad" — Asnad, admin, Operations, TM-001, PIN 123456

### time_off_requests
- "req-asnad-1" — 5-day annual leave (Sep 21–25, 2026), approved

### public_holidays
- 5 US federal holidays for late 2026 (Labor Day through Day After Thanksgiving)

## Important Notes
1. Uses ON CONFLICT DO NOTHING so re-running is safe.
2. Allowances stored as JSONB matching the app's LeaveAllowance shape.
*/
